...
git clone https://github.com/MacCracken/badal.git
cd badal
...
- Meteorological values must cite WMO/NWS standards or published references.
...
```
add Penman-Monteith evapotranspiration

fix SCP normalization to match SPC conventions
```

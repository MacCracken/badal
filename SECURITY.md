...
If you discover a security vulnerability in badal, please report it
...
This policy covers the `badal` crate and its published API. Vulnerabilities
in dependencies should be reported to the respective upstream projects (and
flagged here if they affect badal users).
